...
The containers are now built and running. You should be able to access the odoo installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
